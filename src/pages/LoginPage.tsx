        ...
        <div className="min-h-screen flex font-['Inter']">
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12 bg-[#F9FAFB]">
                <div className="w-full max-w-[420px]">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-[#111827] font-['Outfit'] mb-2">Entrar</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-[#E5E7EB] bg-white text-[#111827] placeholder-[#9CA3AF] focus:outline-none transition-all"
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className="w-full pl-11 pr-12 py-3.5 rounded-xl border border-[#E5E7EB] bg-white text-[#111827] placeholder-[#9CA3AF] focus:outline-none transition-all"
                                onFocus={e => e.currentTarget.style.borderColor = '#1A4D2E'}
                                onBlur={e => e.currentTarget.style.borderColor = '#E5E7EB'}
                            />
                            <button
                    ...
                    <p className="text-center text-[#6B7280] mt-6">
                        Não tem conta?{' '}
                        <Link to="/cadastro" className="font-semibold hover:underline" style={{ color: '#1A4D2E' }}>
                            Criar conta grátis
                        </Link>
                    </p>
